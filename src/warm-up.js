...
var sequel = movie + "2: return of " + title;
...
if (pages < 1000){
    ...
    console.log("Ok, I could maybe read that in a day and a half.");
}
...
var books = ["Cat", "Dog", "Lizards", "Guiness book of World records", "Lovers"];
